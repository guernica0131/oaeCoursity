 ...
 */
function wida_radix_css_alter(&$css) {
  ...
  if (isset($css['misc/ui/jquery.ui.theme.css'])) {
    $css['misc/ui/jquery.ui.theme.css']['data'] =
      drupal_get_path('theme', 'wida_radix') . '/assets/vendor/jqueryui/jquery-ui-1.10.0.custom.css';
  }
}
 ...
 */
function wida_radix_module_implements_alter(&$implementations, $hook) {
 ...
 */
function wida_radix_preprocess_page(&$vars) {
