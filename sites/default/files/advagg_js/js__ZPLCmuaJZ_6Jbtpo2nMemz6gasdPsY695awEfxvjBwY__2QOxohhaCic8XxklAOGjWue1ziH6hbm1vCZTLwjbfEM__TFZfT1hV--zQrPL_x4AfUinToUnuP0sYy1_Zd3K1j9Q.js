...
Drupal.behaviors.PanelizerIPE = {
  attach: function (context) {
    $('input#panelizer-save-default:not(.panelizer-bound)', context).addClass('panelizer-bound').bind('mouseup', function (e) {
    ...
    $('input#panelizer-ipe-revert:not(.panelizer-bound)', context).addClass('panelizer-bound').bind('mouseup', function (e) {
